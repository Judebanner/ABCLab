...
function PatientRegistration() {
    ...
    return (
            ...
            <div className="flex justify-end items-end  bg-[#000537]">
            <div className="max-w-lg w-full bg-[#000537] rounded-lg shadow-lg p-8">
                <h2 className="text-2xl text-[#D4BC36] font-semibold mb-8 text-center">Patient Registration</h2>
