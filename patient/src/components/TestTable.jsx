...
const TestTable = () => {
  ...
  return (
    <div className="container mx-auto">
      <h2 className="text-xl font-semibold text-red-600 mb-4">Test Table</h2>
          ...
          {tests.map((test) => (
            <tr key={test.id}>
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                ...
                <button onClick={() => handleDownloadPDF(test)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-2">
                  Download PDF
                </button>
              </td>
            </tr>
